<div class="modal-dialog text-center">
    <div class="col-sm-8 main-section1">
        <div class="modal-content">
            ...
            <form name="formulario" action="<?php echo base_Url(); ?>/public/addPropietario" method="POST" class="col-12">
                ...
                <div class="mb-3" id="grupocountryuser">
                    <div class="form-group">
                        ...
                        <input type="text" name="telephoneuser" id="countryuser" class="form-control" placeholder="Ingrese el telefono">
